...
export async function resolveEventFeed(config, saved, fetcher = fetchText) {
  ...
  try {
    ...
    // Freeze relative external links against their own source, not against the portal.
...
export async function build() {
  ...
  // Explicit allow-list: never publish .git, workflows, test output or arbitrary local files.
